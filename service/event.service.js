...
var EventService = /** @class */ (function () {
    ...
    EventService.prototype.createEvent = function (eventData) {
        return __awaiter(this, void 0, void 0, function () {
            var existEvent, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.eventRepository.getEvent(eventData)];
                    case 1:
                        existEvent = _a.sent();
                        if (existEvent.length) {
                            this.logger.error("EventService: createTask | event exist");
                            return [2 /*return*/, { error: "event exist" }];
                        }
                        return [4 /*yield*/, this.eventRepository.createEvent(eventData)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.eventRepository.getEvents()];
